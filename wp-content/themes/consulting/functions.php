...
if (!function_exists('consulting_theme_setup')) {
    ...
    function consulting_theme_setup()
    {
        ...
        add_image_size('consulting-image-350x204-croped', 350, 204, false);
        if (stm_check_layout('layout_16')) {
            add_image_size('consulting-image-350x250-croped', 350, 250, array('center', 'top'));
        } else {
            add_image_size('consulting-image-350x250-croped', 350, 250, false);
        }
        add_image_size('consulting-image-1110x550-croped', 1110, 550, false);
        add_image_size('consulting-image-50x50-croped', 50, 50, false);
        add_image_size('consulting-image-320x320-croped', 320, 320, false);
        add_image_size('consulting-image-255x182-croped', 255, 182, false);
        add_image_size('consulting-image-350x195-croped', 350, 195, false);
