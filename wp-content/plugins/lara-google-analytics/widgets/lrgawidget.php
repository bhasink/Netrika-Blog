...
<div class="box box-primary" id="lrgawidget">
  <div class="box-header with-border">
    ...
    <div class="box-tools pull-right">
		...
		<span id="lrgawidget_remove"><i class="fas fa-times"></i></span>
    </div>
  </div>
  <div id="lrgawidget_body" class="box-body">
	<div class="nav-tabs-custom" id="lrgawidget_main">
        ...
        <?php } if (in_array("sessions",DataStore::$RUNTIME["permissions"])){  $actLrgaTabs[] = "lrgawidget_sessions_tab"; ?>
			<li><a data-toggle="tab" data-target="#lrgawidget_sessions_tab" href="#lrgawidget_sessions_tab"><i class="fas fa-chart-line fa-fw"></i><span class="hidden-xs hidden-sm"> <?php _e('Sessions', 'lara-google-analytics'); ?></span></a></li>
									 ...
									 <div id="lrgawidget_advanced_setup" style="display: none;">
										...
										<div class="col-md-6">
											...
											<ol>
												...
												<li><?php _e('Repeat the above step to enable <b>Google Analytics Reporting API</b> and <b>Google Search Console API</b>.', 'lara-google-analytics'); ?></li>
...
<?php
$traching_enabled = "";
$enable_universal_tracking = DataStore::database_get("settings","enable_universal_tracking");
									...
									<div class="col-md-6">
									    <div>
											<h2 ><?php _e('Profile Details', 'lara-google-analytics'); ?></h2>
											 ...
											 <br><label><?php _e('View Time Zone', 'lara-google-analytics'); ?> :</label> <i id="lrgawidget-vtimezone"></i> <i id="lrgawidget-timezone-show-error" class="icon fas fa-exclamation-triangle" style="display:none; color: #f39c12;margin-left: 5px;cursor: pointer;"></i>
											 <div style="display:none; margin-top: 15px;" id="lrgawidget-timezone-error">
												 <div class="alert alert-warning">
													<i class="icon fas fa-exclamation-triangle"></i><?php _e('The selected view is using a different timezone than your server\'s time zone, which <u>may</u> cause inaccurate dates/values.', 'lara-google-analytics'); ?>
			...
			<div class="row">
				<div class="col-lg-6 text-center">
					<div class="lrga_gpro_who">
						<h4><strong>Want some amazing themes ?</strong></h4>
						<p>Check our partner StudioPress and their wonderful Genesis Framework.</p>
						<a href="https://shareasale.com/r.cfm?b=1320634&u=2460281&m=41388&urllink=&afftrack=" target="_blank"><img alt="" class=" img-responsive center-block" src="<?php echo lrgawidget_plugin_dist_url.'/img/pa_studiopressthemes.png'; ?>"></a>
						<br>
					</div>
				</div>
				<div class="col-lg-6 text-center">
